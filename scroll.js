(() => {
  ...
  t1.from('.greeting.bride .greeting-text-1', {transform: 'scale(0)', height:0}, 0)
  ...
  t2.from('.t2 .img-together', {opacity: 0})
  ...
  t2.to('.t2 .img-together', {opacity: 0})
  ...
  t3.to('.when-answer, .when-answer p', {fontSize: '2rem', display: 'flex', y: -80, duration: 3})
  ...
  t5.from('.text-like-this', {opacity: 0}, 0)
  t5.from('.img-together2', {opacity: 0}, 0)
  t5.to('.img-together2', {width: '120%', left: 0, bottom: 0, duration: 2}, 2)
